...
// Handle session for both Admin and Delivery Rider
if (isset($_SESSION['admin_id'])) {
   $admin_id = $_SESSION['admin_id'];
} elseif (isset($_SESSION['delivery_id'])) {
   $admin_id = $_SESSION['delivery_id'];
} else {
   header('location:login.php');
   exit;
}

// FETCH PROFILE DATA (Crucial for populating the form)
...
if(isset($_POST['update_profile'])){
   ...
   if(!empty($update_pass) || !empty($new_pass) || !empty($confirm_pass)){
      if($update_pass != $old_pass){
       ...
       if(empty($message)) $message[] = 'Profile details updated!';
   }
      ...
      <div class="content-scroll">
         ...
         <div class="profile-card">
            <form action="" method="post" enctype="multipart/form-data" autocomplete="off">
               ...
               <div class="space-y-6">
                  <div>
                     <label class="ag-label">Admin Name</label>
               ...
               <div class="mt-8 pt-4">
                  ...
                  <a href="admin_page.php" class="btn-cancel">Cancel & Go Back</a>
               </div>
